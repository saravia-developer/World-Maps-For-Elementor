...
return [
  [
    ...
    [
      ...
      [
        'id' => 'map_venelueza_repeater',
        'args' => [
          'label' => esc_html__('Repeater', 'textdomain'),
          'type' => \Elementor\Controls_Manager::REPEATER,
          'fields' => [
            [
              'name' => 'map_venelueza_repeater_title',
            ...
            [
              'name' => 'map_venelueza_repeater_content',
            ...
            [
              'name' => 'map_venelueza_repeater_fill',
            ...
            [
              'name' => 'map_venelueza_repeater_stroke',
            ...
            [
              'name' => 'map_venelueza_repeater_title_color',
            ...
            [
              'name' => 'map_venelueza_repeater_title_size',
            ...
            [
              'name' => 'map_venelueza_repeater_background_color_container_message',
            ...
            [
              'name' => 'map_venelueza_repeater_position_x',
              'type' => \Elementor\Controls_Manager::SLIDER,
            ...
            [
              'name' => 'map_venelueza_repeater_position_y',
              'type' => \Elementor\Controls_Manager::SLIDER,
